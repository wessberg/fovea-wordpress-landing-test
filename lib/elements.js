    ...
    static markup() {
        return `
			<app-footer-element dark>
					...
					<anchor-element href="/" target="_self" slot="row1">Your first component</anchor-element>
					<anchor-element href="/" target="_self" slot="row1">Your first app</anchor-element>
					<anchor-element href="/" target="_self" slot="row1">Tool integration</anchor-element>
					
					<h3 slot="row2">Help</h3>
					<anchor-element href="/" target="_self" slot="row2">Report issue</anchor-element>
					<anchor-element href="/" target="_self" slot="row2">Stack overflow</anchor-element>
					<anchor-element href="/" target="_self" slot="row2">License</anchor-element>
					
					<h3 slot="row3">About</h3>
					<anchor-element href="/" target="_self" slot="row3">Author</anchor-element>
					<anchor-element href="/" target="_self" slot="row3">Motivation</anchor-element>
					<anchor-element href="/" target="_self" slot="row3">Benchmarks</anchor-element>
					
					<h3 slot="row4">Resources</h3>
					<anchor-element href="/" target="_self" slot="row4">Learn</anchor-element>
					<anchor-element href="/" target="_self" slot="row4">Advanced</anchor-element>
					<anchor-element href="/" target="_self" slot="row4">FAQ</anchor-element>
					
					<h3 slot="row5">News</h3>
					<anchor-element href="/" target="_self" slot="row5">Releases</anchor-element>
					<anchor-element href="/" target="_self" slot="row5">Blog</anchor-element>
					<anchor-element href="/" target="_self" slot="row5">Press</anchor-element>
					
					<h3 slot="row6">Links</h3>
					<anchor-element href="/" target="_self" slot="row6">Github</anchor-element>
					<anchor-element href="/" target="_self" slot="row6">NPM</anchor-element>
					<anchor-element href="/" target="_self" slot="row6">Twitter</anchor-element>
